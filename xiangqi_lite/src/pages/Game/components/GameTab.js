  ...
  return (
    <div className="tabs-container">
      <div className="tab-menu">
        ...
        >
          <img
            src="https://d2g1zxtf4l76di.cloudfront.net/images/new-ui/chat-icon.svg"
            className="to-white"
            alt="chat icon"
          ></img>
          <h3>Chat</h3>
        ...
        >
          <img
            src="https://d2g1zxtf4l76di.cloudfront.net/images/new-ui/game-icon-red.svg"
            alt="moves icon"
          ></img>
          <h3>Moves</h3>
        </button>
        ...
        >
          <img
            src="https://d2g1zxtf4l76di.cloudfront.net/images/new-ui/viewers-icon-red.svg"
            className="to-white"
            alt="viewers icon"
          ></img>
          <h3>Viewers</h3>
